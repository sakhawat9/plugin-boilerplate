 ...
 *
 */
if ( ! class_exists( 'PLUGIN_BOILERPLATE_Fields' ) ) {
  abstract class PLUGIN_BOILERPLATE_Fields extends PLUGIN_BOILERPLATE_Abstract {
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="plugin-boilerplate-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="plugin-boilerplate-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="plugin-boilerplate-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="plugin-boilerplate-help"><span class="plugin-boilerplate-help-text">'. $this->field['help'] .'</span><i class="fas fa-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="plugin-boilerplate-error-text">'. $this->field['_error'] .'</div>' : '';
