...
if ( ! class_exists( 'PLUGIN_BOILERPLATE_Abstract' ) ) {
  abstract class PLUGIN_BOILERPLATE_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        PLUGIN_BOILERPLATE::$css = apply_filters( "PLUGIN_BOILERPLATE_{$this->unique}_output_css", PLUGIN_BOILERPLATE::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'PLUGIN_BOILERPLATE_Field_' . $field_type;
            ...
            if ( class_exists( $field_class ) ) {
              ...
              if ( method_exists( $field_class, 'output' ) || method_exists( $field_class, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  PLUGIN_BOILERPLATE::$css .= $instance->output();
                }
