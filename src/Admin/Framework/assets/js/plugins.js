...
(function($) {
  ...
  function PLUGIN_BOILERPLATEAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  PLUGIN_BOILERPLATEAjaxChosen.prototype.init = function() {
  ...
  PLUGIN_BOILERPLATEAjaxChosen.prototype.events = function() {
  ...
  PLUGIN_BOILERPLATEAjaxChosen.prototype.search_field_focused = function() {
  ...
  PLUGIN_BOILERPLATEAjaxChosen.prototype.search_welcome_message = function() {
  ...
  PLUGIN_BOILERPLATEAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('plugin-boilerplate-chosen', _this.options.data).done( function( response ) {
  ...
  PLUGIN_BOILERPLATEAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.plugin-boilerplate-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.PLUGIN_BOILERPLATEChosenOrder($hidden_value, true);
  ...
  $.fn.PLUGIN_BOILERPLATEAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new PLUGIN_BOILERPLATEAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, PLUGIN_BOILERPLATEAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  PLUGIN_BOILERPLATEAbstractChosenOrder = (function() {

    function PLUGIN_BOILERPLATEAbstractChosenOrder() {}

    PLUGIN_BOILERPLATEAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    PLUGIN_BOILERPLATEAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    PLUGIN_BOILERPLATEAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    PLUGIN_BOILERPLATEAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    PLUGIN_BOILERPLATEAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    PLUGIN_BOILERPLATEAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    PLUGIN_BOILERPLATEAbstractChosenOrder.PLUGIN_BOILERPLATEChosenOrder = function(select, order, force) {
    ...
    return PLUGIN_BOILERPLATEAbstractChosenOrder;
  ...
  $.fn.extend({
    PLUGIN_BOILERPLATEChosenOrder: function(order, force) {
      return _PLUGIN_BOILERPLATEChosenOrder.PLUGIN_BOILERPLATEChosenOrder(this, order, force);
    }
  });

  this._PLUGIN_BOILERPLATEChosenOrder = (function(_super) {
    __extends(_PLUGIN_BOILERPLATEChosenOrder, _super);

    function _PLUGIN_BOILERPLATEChosenOrder() {
      _ref = _PLUGIN_BOILERPLATEChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _PLUGIN_BOILERPLATEChosenOrder.relAttributeName = 'data-option-array-index';

    _PLUGIN_BOILERPLATEChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _PLUGIN_BOILERPLATEChosenOrder.getDOMElement = function(element) {
    ...
    _PLUGIN_BOILERPLATEChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _PLUGIN_BOILERPLATEChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _PLUGIN_BOILERPLATEChosenOrder;

  })(PLUGIN_BOILERPLATEAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('plugin-boilerplate-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('plugin-boilerplate-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectPLUGIN_BOILERPLATE = FormSerializer.serializeObject;
    $.fn.serializeJSONPLUGIN_BOILERPLATE   = FormSerializer.serializeJSON;
  }
