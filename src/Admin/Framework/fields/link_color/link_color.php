 ...
 *
 */
if ( ! class_exists( 'PLUGIN_BOILERPLATE_Field_link_color' ) ) {
  class PLUGIN_BOILERPLATE_Field_link_color extends PLUGIN_BOILERPLATE_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'plugin-boilerplate' ),
        'hover'    => esc_html__( 'Hover', 'plugin-boilerplate' ),
        'active'   => esc_html__( 'Active', 'plugin-boilerplate' ),
        'visited'  => esc_html__( 'Visited', 'plugin-boilerplate' ),
        'focus'    => esc_html__( 'Focus', 'plugin-boilerplate' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="plugin-boilerplate--left plugin-boilerplate-field-color">';
          echo '<div class="plugin-boilerplate--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="plugin-boilerplate-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
