 ...
 *
 */
if ( ! class_exists( 'PLUGIN_BOILERPLATE_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class PLUGIN_BOILERPLATE_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
